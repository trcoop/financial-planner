...
import { RetirementNumberCalculator } from './components/RetirementNumberCalculator/RetirementNumberCalculator'
...
const CALCULATORS: CalculatorEntry[] = [
  ...
  { id: 'retirement-number', label: 'Retirement Number', component: RetirementNumberCalculator },
]
